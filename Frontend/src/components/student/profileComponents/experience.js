...
import { updateStudentExperience } from '../../../mutations/mutations'
    ...
    updateProfile = async (e) => {
        ...
        let res = await this.props.client.mutate({
            ...
            variables: {
                ...
                experienceId: this.state.b_id ? this.state.b_id : "",
                ...
                year_of_ending: Number(this.state.year_of_ending),
                month_of_ending: Number(this.state.month_of_ending)
            },
            refetchQueries: [{
                query: student,
