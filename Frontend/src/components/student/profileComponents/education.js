...
import { updateStudentEducation } from '../../../mutations/mutations'
        ...
        if (nextProps.profile !== undefined) {
            ...
            if (this.state.education) {
                this.setState({
                    ...
                    b_id: nextProps.educationstu_id?nextProps.educationstu_id:""
                })
            }
        }
    }
    ...
    updateProfile = async (e) => {
        ...
        let res = await this.props.client.mutate({
            ...
            variables: {
                ...
                educationId: this.state.b_id?this.state.b_id:"",
                college_name: this.state.college_name,
                location: this.state.location,
                degree: this.state.degree,
                major: this.state.major,
                cgpa: this.state.cgpa,
                year_of_starting: Number(this.state.year_of_starting),
                month_of_starting: Number(this.state.month_of_starting),
                year_of_passing: Number(this.state.year_of_passing),
                month_of_passing: Number(this.state.month_of_passing)
            },
            refetchQueries: [{
                query: student,
